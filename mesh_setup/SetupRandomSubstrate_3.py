...
class SetupRandomSubstrate:
    def __init__(self):
        ...
        self.gradient = {
            ...
            # ],
            "values": torch.tensor([0., 1000., 2000., 4000., 6000.]),  # (+10000 if SNR allows)
            "values_type": "b",
            # "sequences": [
            ...
            "sequences": [
                ...
                PGSE(3000, 8000),   # Δ=8ms  - intermediate
                PGSE(4000, 16000),  # Δ=16ms - slower exchange (τ=10-30ms)
                PGSE(5000, 25000),  # Δ=25ms - long-time reference
            ],
        ...
        self.mf = {
            ...
            "neig_max": 750,   # 500–600 is a good fixed budget; you don’t need 1000
            "ninterval": 375,  # fewer intervals is fine with δ=5 ms
        }